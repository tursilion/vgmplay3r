# hacked to /not/ write to the sound chip,
# this allows the external code to delay it
...
stpl4
	...
	ci r0,>1000				# can we get around this? 			22
	jl stvl						# it's okay											12
	li r0,>0f00       # clamp to silence							20
stvl	
